...
export default async function AppLayout({ children }) {
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      {/* Top bar */}
      <header className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between border-b border-white/[0.05] bg-atmosphere-night px-5 py-3.5 backdrop-blur-2xl">
